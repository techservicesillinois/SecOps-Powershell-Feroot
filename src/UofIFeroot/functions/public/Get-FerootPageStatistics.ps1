...
.EXAMPLE
    Get-FerootPageStatistics -StartDate (Get-Date).AddDays(-30) -EndDate (Get-Date)
.EXAMPLE
    Get-FerootPageStatistics -ProjectUUIDs @('00000000-0000-0000-0000-000000000000', '11111111-0000-0000-0000-1111111111111') -StartDate (Get-Date).AddDays(-30) -EndDate (Get-Date)
#>
function Get-FerootPageStatistics{
    [CmdletBinding()]
    param (
        [string[]]$ProjectUUIDs,
